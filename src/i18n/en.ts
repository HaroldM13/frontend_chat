...
const en: Translations = {
  ...
  chat: {
    ...
    noMessagesPreview: 'No messages · Start this conversation',
    loadMore: 'Load earlier messages',
    addFavorite: 'Add to favorites',
    removeFavorite: 'Remove from favorites',
    clearChat: 'Clear conversation',
    clearChatConfirm: 'Delete all messages? This action cannot be undone.',
  ...
  profile: {
    ...
    descriptionPlaceholder: 'Tell us something about you...',
    noDescription: 'Add a description',
    descriptionSuccess: 'Description updated',
  ...
  polls: {
    ...
    createBtn: 'Publish poll',
    vote: 'Vote',
    voted: 'Voted',
    votes: 'votes',
    noExpiry: 'No expiry',
    expiry1min: '1 minute',
    expiry5min: '5 minutes',
    expiry1h: '1 hour',
  ...
  messages: {
    ...
    selfDestruct: 'Self-destructing message',
  },
  ...
  common: {
    ...
    micStart: 'Record audio',
    micStop: 'Stop recording',
    attachFile: 'Attach file',
    lastSeen: 'Seen',
    lastSeenAt: 'Seen today at',
